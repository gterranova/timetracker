...
class TextCtrlAutoComplete (wx.TextCtrl, listmix.ColumnSorterMixin ):
    ...
    def __init__ ( self, parent, colNames=None, choices = None,
        ...
        self.sm_dn = self.il.Add(wx.ArtProvider.GetBitmap(wx.ART_FOLDER, wx.ART_OTHER, (16,16)))
        self.sm_up = self.il.Add(wx.ArtProvider.GetBitmap(wx.ART_FOLDER, wx.ART_OTHER, (16,16)))
    ...
    def SetChoices(self, choices):
        ...
        for num, colVal in enumerate(self._choices):
            index = self.dropdownlistbox.InsertImageStringItem(sys.maxint, colVal, 0)
